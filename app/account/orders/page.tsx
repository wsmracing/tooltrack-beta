...
export default function OrdersPage() {
  ...
  return <div className="pageWidth pagePad narrowContent">
    ...
    <div className="sectionTitleRow"><div><p className="eyebrow red">Account</p><h1>My orders</h1><p className="muted">Prototype shop orders linked to your account.</p></div><ShopIcon /></div>
    ...
    </article>)}</div> : <div className="emptyPanel"><ShopIcon /><h2>No orders yet</h2><p>Orders placed in the prototype shop will appear here.</p><Link className="button primary" href="/shop">Open shop</Link></div>}
  </div>;
}
